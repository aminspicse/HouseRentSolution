...
// reference Link: https://www.youtube.com/watch?v=exo7NwC2joE&list=PLeSuKd7QCa4bcla2vqbP3D6Uriw1RAvDA&index=6
...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // when user click login then action this code
        ...
        // when user click registration button then work this function
    ...
    //Validate password and confirm passwrod for user
